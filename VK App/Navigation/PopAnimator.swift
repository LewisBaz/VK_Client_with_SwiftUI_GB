    ...
    func animateTransition(using transitionContext: UIViewControllerContextTransitioning) {
        ...
        UIView.animateKeyframes(
            ...
            animations: {
                ...
                let scaleSourceVC = CGAffineTransform(scaleX: 1.2, y: 1.2)
                ...
                let scaleDestinationVC = CGAffineTransform(scaleX: 0.7, y: 0.7)
                destinationVC.view.transform = scaleDestinationVC.concatenating(translationDestinationVC)
